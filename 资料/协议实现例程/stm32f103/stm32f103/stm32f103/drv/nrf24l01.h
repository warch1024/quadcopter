...
#define NRF24L01_GPIO_CE               GPIOA,GPIO_Pin_0
#define NRF24L01_GPIO_CSN              GPIOA,GPIO_Pin_1

#define NRF24L01_GPIO_SCLK             GPIOA,GPIO_Pin_2
#define NRF24L01_GPIO_MOSI             GPIOA,GPIO_Pin_3
#define NRF24L01_GPIO_MISO             GPIOA,GPIO_Pin_4

#define NRF24L01_GPIO_WRITE(X,Y)       if(Y){GPIO_SetBits(X);} else {GPIO_ResetBits(X);}

// CE Pin & CSN Pin & IRQ Pin
#define CE(x)       NRF24L01_GPIO_WRITE(NRF24L01_GPIO_CE,x)
#define CSN(x)      NRF24L01_GPIO_WRITE(NRF24L01_GPIO_CSN,x)
...
#define NRF24L01_PLOAD_WIDTH        16   // Payload width
